...
|---------|--------|-----|----------------|-------|
| v2.4.8 | `v2.4.8` (release tag) | Pending | Pending | Patch release: bounds navigation tracking while preserving safety errors and tab-lock reuse; refreshes production dependencies within Express 4 and preserves request-body and image-filter compatibility. |
