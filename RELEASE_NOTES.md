...
|---------|--------|-----|----------------|-------|
| v2.4.8 | `9a6b81b` | [Published 2026-09-22](https://www.npmjs.com/package/camofox-browser/v/2.4.8) | [Published 2026-09-22](https://github.com/redf0x1/camofox-browser/releases/tag/v2.4.8) | Patch release: bounds navigation tracking while preserving safety errors and tab-lock reuse; refreshes production dependencies within Express 4 and preserves request-body and image-filter compatibility. |
| v2.4.7 | `4c43cb8` | Published 2026-08-13 | Published | Adds verified Windows x64 portable distribution, platform guards, session-scoped recovery and teardown isolation. |
